...
@section('title_1','用户列表 - 腾讯课堂后台管理系统')
@section('title_2','用户列表')
    ...
    <div class="panel-body">
        <div class="dataTable_wrapper">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
              <form class="" action="/admin/user/list">
              <div class="row">
                <div class="col-sm-6">
               ...
               <div class="col-sm-12">
                ...
                <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 204px;">用户名</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 185px;">邮箱</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 149px;">手机号</th>
                ...
                <tbody>
                    ...
                    <tr class="gradeA odd" role="row">
                        ...
                        <td class="center">
                          ...
                          <a href="/admin/user/delete?id={{$v->id}}">删除</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>

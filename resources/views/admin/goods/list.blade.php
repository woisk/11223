...
@section('title_1','商品列表 - 腾讯课堂后台管理系统')
@section('title_2','商品列表')
               ...
               <div class="col-sm-12">
                ...
                <tbody>
                    ...
                    <tr class="gradeA odd" role="row">
                        ...
                        <td class="center">
                          <a href="/admin/goods/edit?id={{$v->id}}">编辑 |</a>
                          <a href="/admin/goods/delete?id={{$v->id}}">删除 |</a>
                          <a href="/admin/goods/recycle?id={{$v->id}}">移入回收站</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>

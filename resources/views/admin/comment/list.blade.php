...
@section('title_1','评论列表 - 腾讯课堂后台管理系统')
@section('title_2','评论列表')
    ...
    <div class="panel-body">
        <div class="dataTable_wrapper">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
              <form class="" action="/admin/comment/lists">
              <div class="row">
                <div class="col-sm-6">
               ...
               <div class="col-sm-12">
                ...
                <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 77px;">评论内容</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 77px;">评价时间</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 77px;">评论人ID</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 77px;">评价的商品</th>
                ...
                <tbody>
                    ...
                    <tr class="gradeA odd" role="row">
                        ...
                        <td class="center">{{$v->good_id}}</td>
                        <td class="center">
                          <a href="/admin/comment/deletes?id={{$v->id}}">删除该评论</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>

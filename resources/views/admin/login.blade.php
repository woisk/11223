                        ...
                        <form role="form" action="/admin/login" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="请输入有效的管理账户" name="username" type="text" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="请输入有效的管理密钥" name="password" type="password" value="">
                                </div>
                                <div class="checkbox">
                                    <label>

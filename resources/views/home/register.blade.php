...
<div class="wrapper clearfix">
	<div class="wrap_box">
		...
		<p class="tips"><span class="gray f_r">已有腾讯课堂帐号？请点<a class="orange bold" href="/login">这里</a>登录</span>欢迎来到我们的网站，如果您是新用户，请填写下面的表单进行注册</p>
		<div class="box clearfix">
            ...
            <th>邮箱：</th>
            <td>
              <input class="gray" type="text" name='email' pattern="email" alt="填写正确的邮箱格式" />
            ...
            <th>用户名：</th>
            <td>
              <input class="gray" name='username' type="text" pattern="^[\w\u0391-\uFFE5]{2,20}$" alt="填写2-20个字符，可以为字数，数字下划线和中文" />
              <label>请填写用户名，格式为2-20个字符，可以为字数，数字下划线和中文</label>
            </td>
          </tr>
					<tr>
            <th>设置密码：</th>
          ...
          {{csrf_field()}}
					<tr><td></td><td><input class="submit_login" type="submit" value="同意以下条款，提交" /><label></label></td></tr>
				</table>
			</form>

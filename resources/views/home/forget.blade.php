...
<div class="container_2">
	...
	<div class="wrap_box">
		...
		<div class="box">
		<form action="/forget" method="post" id="mailWay">
			<table class="form_table">
				...
				<tr>
					<td></td>
					<td><input class="submit_login" type="submit" value="找回密码" /></td>
				</tr>
				<tr><td></td><td><a href="javascript:changeTab()" class="link">手机短信重置密码</a></td></tr>
			</table>
		</form>

		<form action="/forget" method="post" id="mobileWay" style="display:none">
			<table class="form_table">
				<colgroup>
					<col width="300px" />
					<col />
...
function sendMessage()
{
	...
	$.get("/tpl/txkt/simple/send_message_mobile",{"username":username,"mobile":mobile},function(content){
		if(content == 'success')
		{
			alert('发送成功，请查看您的手机');
		}
